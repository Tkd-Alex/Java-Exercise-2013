...
class Calcolatrice{
	public static void main(String s[]){
		...
		final JTextField t1p1=new JTextField();
		t1p1.setEditable(false); //Disattivo il textfield
		t1p1.setHorizontalAlignment(JTextField.CENTER); 
		...
		b5p5.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						t1p1.setText("+");
						t.setText("");
						//calc=Integer.parseInt(t.getText());
				}
			}
		);
		...
		b6p5.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						String ris;
						t1p1.setText("");
						//calc+=Integer.parseInt(t.getText());
						//ris = String.valueOf(calc);
						//t.setText(ris);
				}
			}
		);
